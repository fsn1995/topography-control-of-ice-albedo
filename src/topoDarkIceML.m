...
exportgraphics(f1, 'print/SEconfusion.png', 'Resolution',300);
...
grid on
fontsize(gcf,scale=1.2)
exportgraphics(f2, 'print/SEimportance.png', 'Resolution',300);
...
fontsize(gcf,scale=1.2)
exportgraphics(f3, 'print/SEpie.png', 'Resolution',300);
