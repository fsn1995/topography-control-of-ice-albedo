...
# aoi = ee.FeatureCollection("projects/ee-deeppurple/assets/icePoly")
...
aoi = ee.Geometry.Polygon(
        [[[-57.465785647531675, 72.66966646738942],
          [-54.213832522531675, 65.96025391242586],
          [-49.643520022531675, 60.51717602833715],
          [-46.479457522531675, 59.949941758945776],
          [-43.183559085031675, 59.595972956748824],
          [-42.084926272531675, 60.495540566681235],
          [-38.701137210031675, 65.08638182075724],
          [-35.405238772531675, 65.8705869499152],
          [-31.713832522531675, 67.68892842240096],
          [-25.517543460031675, 68.62085394415386],
          [-21.21090283503168, 70.10704075592186],
          [-20.37594189753168, 72.68275211917309]]])# southern greenland
...
def bareiceFilter(image):
  maskMax = image.lte(0.65)
  maskMin = image.gt(0)
  return image.updateMask(maskMax).updateMask(maskMin)
'''
...
multiSat = landsatCol.merge(s2Col).map(bareiceFilter)
...
task = ee.batch.Export.image.toAsset(
  image=albedoImage,
  description="albedoArcticDEMsouth",
  assetId="projects/ee-deeppurple/assets/topography/albedoArcticDEMsouth",
  region=aoi,
  scale=30,
  maxPixels=1e13
)
