...
# yMin = 60.03676
# yMax = 83.64513
# region = ee.Geometry.BBox(west=xMin, south=yMin, east=xMax, north=yMax)
task = ee.batch.Export.image.toAsset(
  image=albedoImage,
  description="albedoArcticDEM",
  assetId="projects/ee-deeppurple/assets/topography/albedoArcticDEM",
  region=aoi,
  scale=30,
  maxPixels=1e13
)
